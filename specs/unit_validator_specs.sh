...
compilation () {
	...
	gcc -Wextra -Wall $OPTION -L../srcs/libft/ -lft -I. -I../srcs/headers ${FUNCTION_NAME}_specs.c utils.c ../srcs/validator/validator_utils.c ../srcs/validator/${FUNCTION_NAME}.c -o ${FUNCTION_NAME}_spec
}
