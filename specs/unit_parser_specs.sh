...
compilation () {
	...
	clang -Wextra -Wall $OPTION -I. -I../srcs/headers ${FUNCTION_NAME}_specs.c utils.c ../srcs/parser/parser_utils.c ../srcs/parser/${FUNCTION_NAME}.c -L../srcs/libft/ -lft -o ${FUNCTION_NAME}_spec
}
