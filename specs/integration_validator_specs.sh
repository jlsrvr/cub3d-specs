...
compilation () {
	...
	clang -Wextra -Wall $OPTION -I. -I../srcs/minilibx-linux -I../srcs/headers cub_validator_specs.c utils.c ../srcs/cub_utils.c ../srcs/validator/*.c -L../srcs/libft/ -lft -L../srcs/minilibx-linux/ -lmlx -lXext -lX11 -lm -o cub_validator_spec
}
