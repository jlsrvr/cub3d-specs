...
compilation () {
	...
	gcc -Wextra -Wall $OPTION -L../srcs/libft/ -lft -I. -I../srcs/headers cub_parser_specs.c utils.c ../srcs/parser/*.c -o cub_parser_spec
}

run_tests () {
	OPTION=$1
	$OPTION ./cub_parser_spec
}
...
rm -rf cub_parser_spec cub_parser_spec.dSYM/
