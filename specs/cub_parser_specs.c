...
int main(void)
{
	...
	cub_parser_test("Simple well formated file", "files/well_formated.cub", 0, &expected, &sucess, &failure);
	expected = filled_t_des(1900, 1800, "./a/no_path.c", "./a/ea_path.c", "./a/so_path.c", "./a/we_path.c", "./a/s_path.c", 0xFFFFFF, 0x000000, "1111>1001>1W01>1111");
	cub_parser_test("Well formated file shuffled", "files/well_formated_shuffled.cub", 0, &expected, &sucess, &failure);
	expected = filled_t_des(1900, 1800, "./a/no_path.c", "./a/ea_path.c", "./a/so_path.c", "./a/we_path.c", "./a/s_path.c", 0xFFFFFF, 0x000000, "1111>1001>1W01>1111");
	cub_parser_test("Well formated with empty lines", "files/WF_with_empty_lines.cub", 0, &expected, &sucess, &failure);
	expected = filled_t_des(1900, 1800, "./a/no_path.c", "./a/ea_path.c", "./a/so_path.c", "./a/we_path.c", "./a/s_path.c", -1, -2, NULL);
	cub_parser_test("Floor color wrong format", "files/invalid_floor_c.cub", 1, &expected, &sucess, &failure);
	expected = filled_t_des(1900, 1800, "./a/no_path.c", "./a/ea_path.c", "./a/so_path.c", "|duplicate|", NULL, -2, -2, NULL);
	cub_parser_test("Duplicate west path", "files/duplicate_we_path.cub", 1, &expected, &sucess, &failure);
	expected = filled_t_des(-1, -1, NULL, NULL, NULL, NULL, NULL, -2, -2, NULL);
	cub_parser_test("Resolution in the wrong format", "files/wrong_format_resolution.cub", 1, &expected, &sucess, &failure);
	expected = filled_t_des(0, 0, NULL, NULL, NULL, NULL, NULL, -2, -2, NULL);
	cub_parser_test("Wrong identifier at start", "files/unknown_identifier.cub", 1, &expected, &sucess, &failure);
