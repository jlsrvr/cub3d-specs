...
int main(void)
{
	...
	cub_parser_test(describe, "files/easy_empty_line_in_map.cub", 1, &expected, &sucess, &failure);
	describe = "All good except line with only space characters in map";
	expected = filled_t_des(1900, 1800, "./a/no_path.c", "./a/ea_path.c", "./a/so_path.c", "./a/we_path.c", "./a/s_path.c", 0xFFFFFF, 0x000000, "1111>1001>1W01");
	cub_parser_test(describe, "files/line_only_space_chars_in_map.cub", 1, &expected, &sucess, &failure);
	describe = "All good, empty lines after the map";
	expected = filled_t_des(1900, 1800, "./a/no_path.c", "./a/ea_path.c", "./a/so_path.c", "./a/we_path.c", "./a/s_path.c", 0xFFFFFF, 0x000000, "1111>1001>1W01>1111");
	cub_parser_test(describe, "files/empty_lines_after_map.cub", 1, &expected, &sucess, &failure);
	...
	describe = "Simple description but with extra valid element after 8 valid ones";
	expected = filled_t_des(1900, 1800, "./a/no_path.c", "./a/ea_path.c", "./a/so_path.c", "./a/we_path.c", "./a/s_path.c", 0xFFFFFF, 0x000000, NULL);
	cub_parser_test(describe, "files/extra_element_after_8_correct.cub", 1, &expected, &sucess, &failure);
	describe = "Simple description but with an element right after map";
	expected = filled_t_des(1900, 1800, "./a/no_path.c", "./a/ea_path.c", "./a/so_path.c", "./a/we_path.c", "./a/s_path.c", 0xFFFFFF, 0x000000, "1111>1001>1W01>1111");
	cub_parser_test(describe, "files/extra_element_right_after_map.cub", 1, &expected, &sucess, &failure);
